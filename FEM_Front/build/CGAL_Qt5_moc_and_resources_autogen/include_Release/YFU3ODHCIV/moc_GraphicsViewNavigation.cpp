...
#include <memory>
#include "D:/vcpkg/installed/x64-windows/include/CGAL/Qt/GraphicsViewNavigation.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CGAL__Qt__GraphicsViewNavigation_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CGAL__Qt__GraphicsViewNavigation_t qt_meta_stringdata_CGAL__Qt__GraphicsViewNavigation = {
    {
QT_MOC_LITERAL(0, 0, 32), // "CGAL::Qt::GraphicsViewNavigation"
QT_MOC_LITERAL(1, 33, 16), // "mouseCoordinates"
QT_MOC_LITERAL(2, 50, 0) // ""

    },
    "CGAL::Qt::GraphicsViewNavigation\0"
    "mouseCoordinates\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_CGAL__Qt__GraphicsViewNavigation[] = {
...
void CGAL::Qt::GraphicsViewNavigation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mouseCoordinates((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsViewNavigation::mouseCoordinates)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CGAL::Qt::GraphicsViewNavigation::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CGAL__Qt__GraphicsViewNavigation.data,
