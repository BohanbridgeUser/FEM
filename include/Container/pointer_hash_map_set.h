...
#ifndef _POINTER_HASH_MAP_SET_H_
#define _POINTER_HASH_MAP_SET_H_
...
// Project includes
#include "../define.h"
#include "../Container/set_identity_function.h"
...
public:
    ...
    TDataType& operator[](const key_type& Key)
    {
        ...
        {
            std::cerr << "The key: " << Key << " is not available in the map" << std::endl;
            exit(0);
        } 
